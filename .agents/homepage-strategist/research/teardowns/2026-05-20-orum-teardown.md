...
| 3 | Final CTA that names the role explicitly ("for the head of sales who wants to see live conversation lift in week 4"). | [FinalCta](../../../../src/components/marketing/v2/final-cta.tsx) variant for the BD-pod cycle: "Wire Revint into your BD pod's morning queue." | Trivial (copy only). | Forwarding moment. The BD manager reads the page, sees themselves named, forwards it. Tests 2 and 4 hinge on this. |
