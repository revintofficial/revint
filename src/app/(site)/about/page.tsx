...
/**
 * /about — who built LeadAC, and why now.
 *
...
export const metadata: Metadata = buildMetadata({
  path: PATH,
  title: "About LeadAC — who built it, and why now",
  description:
...
export default function AboutPage() {
  return (
    <>
      ...
      <Hero
        eyebrow="About"
        headline="We built LeadAC because we kept rebuilding it in our own jobs."
        subhead="The founders previously ran outbound at vertical SaaS companies — restaurant tech, field service software, dental practice management. Every time we changed jobs, the pattern in our SDR team's head got rebuilt from scratch. LeadAC is the system that captures it once."
      ...
      <ManifestoBlock
        ...
        paragraphs={[
          ...
          "We built LeadAC for that segment. Vertical SaaS GTM teams selling to local business — restaurant tech, field service software, dental practice management, beauty and wellness software. The memory layer their CRM never had, at a price that fits a 5-seat team.",
        ]}
        pullQuote={{
          quote:
      ...
      <ManifestoBlock
        ...
        paragraphs={[
          ...
          "LeadAC sits in that gap. We do not replace Apollo's contact list. We do not replace Clay's workflow logic. We do not replace Gong's transcripts. We sit one layer below the orchestrator, one layer above the contact database, and we write twelve fields into your HubSpot company record before your SDR opens the contact.",
