    ...
    <div className="space-y-4">
            ...
            return (
              <li key={s.label} className="flex items-center gap-4">
                <div className="w-28 shrink-0">
                  ...
                  <div className="text-sm text-[var(--leadac-text-1)]">
                    {s.label}
                  </div>
                </div>
                <div className="flex-1">
                  <div className="relative h-8 rounded-md bg-[var(--leadac-hover)] overflow-hidden">
                    <div
                      className="absolute inset-y-0 left-0 bg-[var(--leadac-500)]/80 flex items-center justify-end pr-3 text-xs font-medium text-black"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        ...
        <div className="rounded-xl border border-[var(--leadac-border)] bg-[var(--leadac-card)] p-4">
          ...
          <div className="mt-1 text-sm text-[var(--leadac-text-1)]">
            {(() => {
