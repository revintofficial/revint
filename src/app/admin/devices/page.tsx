  ...
  return (
    <section className="rounded-xl border border-[var(--leadac-border)] bg-[var(--leadac-card)] p-4">
      <header className="flex items-center justify-between mb-2">
        ...
        <span className="text-[10px] text-[var(--leadac-text-3)] tabular-nums">
      ...
      <div className="rounded-xl border border-[var(--leadac-border)] bg-[var(--leadac-card)] overflow-hidden">
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-[var(--leadac-border)]">
            ...
            {rows.map((r) => (
              <tr key={r.key} className="hover:bg-[var(--leadac-hover)]/40">
                <td className="px-3 py-2 align-middle text-[var(--leadac-text-1)] capitalize">
                  {r.label}
                </td>
