...
const WORKER_VISUALS: Partial<Record<AgentWorkerKind, WorkerVisualSeed>> = {
  ...
  APIFY_FACEBOOK_DEEP: { Icon: Facebook, shortLabel: "Facebook deep", longLabel: "Facebook deep scrape", tone: "blue" },
  APIFY_INSTAGRAM_DEEP: { Icon: Instagram, shortLabel: "Instagram deep", longLabel: "Instagram deep scrape", tone: "purple" },
  APIFY_TIKTOK_DEEP: { Icon: Music2, shortLabel: "TikTok deep", longLabel: "TikTok deep scrape", tone: "red" },
  APIFY_LINKEDIN_COMPANY: { Icon: Linkedin, shortLabel: "LinkedIn", longLabel: "LinkedIn company + jobs", tone: "blue" },
...
const MEMORY_VISUALS: Partial<Record<MemoryKind, MemoryVisualSeed>> = {
  ...
  HIRING_SIGNAL: { Icon: Linkedin, shortLabel: "Hiring", longLabel: "Hiring signal memory", tone: "blue" },
